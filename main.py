...
def on_cb(call):
    ...
    # FOYDALANUVCHILAR
        ...
        for k, info in list(d["users"].items())[-15:]:
            un = "@" + esc(info["username"]) if info["username"] else "yoq"
...
if __name__ == "__main__":
    print("FUZZY BOT v6.0 ishga tushdi!")
